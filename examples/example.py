...
# filepath_simple  = os.path.dirname(__file__) + '/sample_topologies/G6/C1/G6C1I0.json'
# filepath_complex = os.path.dirname(__file__) + '/sample_topologies/G10/C4/G10C4I0.json'
